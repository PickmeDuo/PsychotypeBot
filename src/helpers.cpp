...
namespace Psycho {
    ...
    std::string PsychologicalAnalyzerBot::resultDescription(const std::string& psychotype) {
        if (psychotype == "Пикми") {
            ...
            return "Тревожно-мнительный — это человек с повышенной чувствительностью к возможным угрозам и склонностью постоянно анализировать свои действия и переживать о последствиях. Он осторожный, предусмотрительный и всегда стремится избежать ошибок, неловких ситуаций или неодобрения со стороны окружающих. Такой человек часто сомневается в себе, много думает перед принятием любого решения и нередко пересматривает в голове прошедшие события, чтобы убедиться, что всё сделал правильно. Он стремится соблюдать правила, избегает риска и предпочитает заранее продумывать запасные планы. При этом тревожно-мнительный человек может быть очень добросовестным, внимательным к деталям и ответственным, но из-за внутреннего напряжения часто испытывает усталость и тревогу. Он болезненно воспринимает критику, боится осуждения и неудачи, нуждается в поддержке, одобрении и ощущении безопасности. Несмотря на внешнюю застенчивость, внутри него — буря переживаний, из которой рождается стремление быть хорошим, не подвести и не причинить никому вреда.";
